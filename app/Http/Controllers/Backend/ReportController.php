...
class ReportController extends Controller
{
    ...
    public function SaleReport(){
        $salesReport = Sale::with(['saleItems.product', 'customer', 'warehouse'])->get();
        return view('admin.backend.report.sale_report', compact('salesReport'));
    }
    //End Method
    ...
    public function SaleReturnReport(){
        ...
        return view('admin.backend.report.sale_return_report', compact('returnSales'));
    }
    //End Method
