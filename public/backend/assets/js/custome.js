            ...
            .then(data => {
                ...
                if(data.length > 0){
                    data.forEach(product => {
                        ...
                        data-stock="${product.product_quantity}"><span class="mdi mdi-text-search"></span> ${product.code} - ${product.name} </a>`;
                    ...
                    productList.innerHTML = '<p class="text-mute">No Product Found</p>'
                }
            })
    }
