                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item"> <strong>Product Quantity:</strong> {{ $product->product_quantity }}</li>
                            ...
                            <li class="list-group-item"> <strong>Create On:</strong> {{ \Carbon\Carbon::parse($product->created_at)->format('d F Y')  }}</li>
                        </ul>
                    </div>
