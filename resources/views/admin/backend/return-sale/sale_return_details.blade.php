                ...
                <div class="row">
                 ...
                 {{-- supplier-info --}}
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm h-100 border-0" style="border-radius: 10px; transition:0.2s">
                  ...
                  {{-- Purchase-info --}}
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm h-100 border-0" style="border-radius: 10px; transition:0.2s">
                            ...
                            <div class="card-header text-white text-center" style="background:linear-gradient(135deg, #17a2b8, #0d6efd); border-radius: 10px 10px 0 0;">
                                <h5 class="mb-0 fw-bold">Sales Return Information</h5>
                            </div>
                            ...
                            <div class="card shadow-sm h-100 border-0" style="border-radius: 10px; transition:0.2s">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($sale->saleReturnItems as $key=> $item)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
