        ...
        <div class="col-xl-12">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="date" value="{{ $editData->date }}" value="<?php echo date('Y-m-d'); ?>" class="form-control">
                    @error('date')
                ...
                <tbody id="productBody">
                    ...
                    <tr data-id= {{ $item->id }}>
                        <td class="d-flex align-items-center gap-2">
                            <input type="text" class="form-control" value="{{ $item->product->code }} - {{ $item->product->name }}" style="max-width: 300px;" readonly>

                            <button type="button" class="btn btn-primary btn-sm edit-discount-btn" data-id= "{{ $item->id }}"
                        ...
                        <td>
                            <input type="number" name="products[{{ $item->product->id }}][net_unit_cost]" value="{{ $item->net_unit_cost }}" class="form-control net-cost" style="max-width: 90px;" readonly>
                        </td>

                        <td>
                            <input type="number" name="products[{{ $item->product->id }}][stock]" value="{{ $item->product->product_quantity }}" class="form-control" style="max-width: 80px;" readonly>
                        </td>
                        ...
                        <td>
                            <input type="number" name="products[{{ $item->product->id }}][discount]" value="{{ $item->discount }}" style="max-width: 100px;" class="form-control discount-input">
                        </td>
                ...
                <div class="table-responsive">
                    <table class="table border">
                        ...
                        <tr>
                            ...
                            <input type="text" name="paid_amount" value="{{ $editData->paid_amount }}" placeholder="Enter amount paid" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="py-3" id="fullPaid">
                                <input type="text" name="full_amount" value="{{ $editData->full_amount }}" id="fullPaidInput" class="form-control">
                            </td>
                        </tr>
                        <tr>
